...
class WorkflowMonitor:
    ...
    def __init__(self, repo: str, token: Optional[str] = None):
        ...
        if not self.token:
            print("WARNING: GITHUB_TOKEN not set. Some operations may be limited.", file=sys.stderr)
...
def main():
    ...
    parser.add_argument("command", choices=["status", "quality", "alerts"], help="Command to execute")
